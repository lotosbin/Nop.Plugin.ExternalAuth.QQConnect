...
namespace Nop.Plugin.ExternalAuth.QQConnect.Infrastructure.Cache
{
    ...
    /// </summary>
    public partial class QQConnectAuthenticationEventConsumer : IConsumer<CustomerAutoRegisteredByExternalMethodEvent>
    {
        #region Fields
        ...
        public void HandleEvent(CustomerAutoRegisteredByExternalMethodEvent eventMessage)
        {
            ...
            if (!eventMessage.AuthenticationParameters.ProviderSystemName.Equals(QQConnectAuthenticationDefaults.ProviderSystemName))
                return;
